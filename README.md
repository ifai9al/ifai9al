...
const faisal = {
  ...
  codingHours: "3000+",
  techProjects: "20+",
  projects: "Jadawli · Nashrat · RABT · L2S · And more..",
...
### 📅 [Jadawli](https://jadawli.com)
A smart, automated platform that integrates with academic portals to build ideal study schedules with one click.

`Node.js` `Vanilla JS` `Automated System`

</td>
<td width="50%" valign="top">

### ✍️ [Nashrat](https://nashrat.fasr.sa/)
An Arabic platform for writing and publishing personal newsletters — a rich media editor with a standalone profile for every writer.
...
### 🔗 [RABT](https://rabt.it)
A unified smart dashboard empowering creators to establish their digital presence effortlessly.
